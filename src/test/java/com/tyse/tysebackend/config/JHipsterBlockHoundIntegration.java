package com.tyse.tysebackend.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.tyse.tysebackend.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.tyse.tysebackend.security.DomainUserDetailsService", "createSpringSecurityUser");
