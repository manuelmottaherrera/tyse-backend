...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'f785ebe9-0e0b-4ac1-bf62-2a2770330547' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('67b2ce55-4900-4316-8f0c-f55d220e0694');
      cy.get(`[data-cy="name"]`).should('have.value', '67b2ce55-4900-4316-8f0c-f55d220e0694');
